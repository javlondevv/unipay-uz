...
def run_migrations(engine: Any) -> None:
    """
    Run database migrations for UniPay UZ FastAPI integration.

    This function creates all necessary tables in the database for the
    UniPay UZ payment system. Call this function when setting up your FastAPI
